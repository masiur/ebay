                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class=" form">
                            ...
                            {!! Form::model($shop, ['route' => ['shop.tc.update',$shop->id], 'method' => 'PUT', 'files' => 'true', 'class' => 'form-horizontal']) !!}

                            <div class="form-group">
                                {!! Form::label('tc', "Terms & Conditions: ", array('class' => 'control-label col-lg-2')) !!}
                                <div class="col-lg-6">
                                    {!! Form::textarea('tc', null, array('class' => 'form-control','placeholder' => 'Terms and Conditions', 'id' =>'summernote')) !!}
                                </div>
                            </div>
