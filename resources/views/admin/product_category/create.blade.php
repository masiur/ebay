                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">                            
                                <a class="pull-right" href="{!! route('product.category.index')!!}"><button class="btn btn-success">Product Category List</button></a>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="panel-body">
                                ...
                                <div class=" form"> 
                                    ...
                                    {!! Form::open(array('route' => 'product.category.store' , 'method' => 'post', 'class' => 'cmxform form-horizontal tasi-form')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::submit('Add Product Category', array('class' => 'btn btn-primary m-l-10')) !!}
                                        </div>
                                    </div>
