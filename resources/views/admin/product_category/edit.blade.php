                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">                            
                                <a class="pull-right" href="{!! route('product.category.index')!!}"><button class="btn btn-success">Back</button></a>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="panel-body">
                                ...
                                <div class=" form"> 
                                    ...
                                    {!! Form::model($product_category, array('route' => ['product.category.update',$product_category->id], 'method' => 'PUT', 'class' => 'cmxform form-horizontal tasi-form')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::submit('Update Product Category', array('class' => 'btn btn-success m-l-10')) !!}
                                        </div>
                                    </div>
