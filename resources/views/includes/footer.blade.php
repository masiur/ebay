                ...
                <div class="container">
                    <div class="row row-wrap">
                        <div class="col-md-3">
                            ...
                            <p>Cursus cras odio non amet phasellus sapien donec convallis ac tortor nullam et bibendum molestie nisi sem himenaeos sed feugiat</p>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                <form>
                                    ...
                                    <p class="mb10">Senectus magnis erat dapibus volutpat quisque vitae</p>
                            ...
                            <ul class="thumb-list">
                                <li>
                                    ...
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <h5 class="thumb-list-item-title"><a href="#">Vitae condimentum</a></h5>
                                        <p class="thumb-list-item-desciption">Mus blandit montes dignissim malesuada</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Facilisis bibendum</a></h5>
                                        <p class="thumb-list-item-desciption">Mauris rutrum ullamcorper platea euismod</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Elit tristique</a></h5>
                                        <p class="thumb-list-item-desciption">Vestibulum eleifend eget proin vulputate</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
