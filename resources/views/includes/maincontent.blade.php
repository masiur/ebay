                    ...
                    <aside class="sidebar-left">
                        ...
                        <div class="sidebar-box">
                            ...
                            <ul class="thumb-list">
                                <li>
                                    <a href="#">
                                        <img src="couponia/img/food_is_pride_70x70.jpg" alt="Image Alternative text" title="Food is Pride" />
                                    </a>
                                    <div class="thumb-list-item-caption">
                                        <h5 class="thumb-list-item-title"><a href="#">Best Pasta</a></h5>
                                        <p class="thumb-list-item-price">$202</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <p class="thumb-list-item-price">$494</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <p class="thumb-list-item-price">$175</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="sidebar-box">
                            ...
                            <ul class="thumb-list">
                                <li>
                                    <a href="#">
                                        <img src="couponia/img/hot_mixer_70x70.jpg" alt="Image Alternative text" title="Hot mixer" />
                                    </a>
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <p class="thumb-list-item-author">by Sarah Slater</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="couponia/img/our_coffee_miss_u_70x70.jpg" alt="Image Alternative text" title="Our Coffee miss u" />
                                    </a>
                                    <div class="thumb-list-item-caption">
                ...
                <div class="col-md-9">
                    <div id="product-quick-view-dialog" class="mfp-with-anim mfp-hide mfp-dialog mfp-dialog-big clearfix">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <p class="text-smaller text-muted">Lobortis quis sociosqu lorem cras pretium quam parturient euismod et fermentum curabitur cubilia elit mattis nascetur ipsum vulputate sapien viverra fermentum habitasse cras ac nibh phasellus accumsan praesent laoreet scelerisque</p>
                                <ul class="icon-list">
                                    <li><i class="fa fa-check"></i>Id potenti</li>
                                    <li><i class="fa fa-check"></i>Nec auctor</li>
                                    <li><i class="fa fa-check"></i>Praesent class</li>
                                    <li><i class="fa fa-check"></i>Eget fringilla</li>
                                    <li><i class="fa fa-check"></i>Volutpat leo</li>
                                </ul>
                    ...
                    <div class="row row-wrap">
                        ...
                        <div class="col-md-4">
                            <div class="product-thumb">
                                <header class="product-header">
                                    <img src="couponia/img/aspen_lounge_chair_800x600.jpg" alt="Image Alternative text" title="Aspen Lounge Chair" />
                                    <div class="product-quick-view">
                                        <a class="fa fa-eye popup-text" href="#product-quick-view-dialog" data-effect="mfp-move-from-top" data-toggle="tooltip" data-placement="top" title="Quick View"></a>
                                    </div>
                                    <div class="product-secondary-image">
                        ...
                        <div class="col-md-4">
                            <div class="product-thumb">
                                <header class="product-header">
                                    <img src="couponia/img/the_hidden_power_of_the_heart_800x600.jpg" alt="Image Alternative text" title="The Hidden Power of the Heart" />
                                    <div class="product-quick-view">
                                        <a class="fa fa-eye popup-text" href="#product-quick-view-dialog" data-effect="mfp-move-from-top" data-toggle="tooltip" data-placement="top" title="Quick View"></a>
                                    </div>
                                    <div class="product-secondary-image">
                                        <img src="couponia/img/the_violin_800x600.jpg" alt="Image Alternative text" title="The Violin" />
                                    </div>
                                </header>
                                <div class="product-inner">
                                    ...
                                    <div class="product-meta">
                                        <ul class="product-price-list">
                                            <li><span class="product-price">$150</span>
                                            </li>
                                        </ul>
                                        <ul class="product-actions-list">
                                            <li><a class="btn btn-sm" href="#"><i class="fa fa-shopping-cart"></i> To Cart</a>
